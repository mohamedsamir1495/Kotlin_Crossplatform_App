...
@class CommonPlatformSettings, CommonUserModel, CommonKotlinThrowable, CommonGithubPresenter, CommonRepository, CommonExpectSuccess, CommonKtor_client_core_iosHttpClient, CommonKotlinUnit, CommonKtor_utils_iosAttributeKey, CommonApiException, CommonKotlinArray, CommonGithubApi, CommonJsonKotlinxSerializer, CommonKtor_http_iosOutgoingContent, CommonGithubRepositoryImpl, CommonRepositoryCompanion, CommonRepository$serializer, CommonUserJSON, CommonUserJSONCompanion, CommonUserJSON$serializer, CommonKtor_client_core_iosHttpClientConfig, CommonKotlinx_coroutines_core_nativeCoroutineDispatcher, CommonKtor_client_core_iosHttpClientEngineConfig, CommonKtor_client_core_iosHttpReceivePipeline, CommonKtor_client_core_iosHttpRequestPipeline, CommonKtor_client_core_iosHttpResponsePipeline, CommonKtor_client_core_iosHttpSendPipeline, CommonKtor_client_core_iosHttpClientCall, CommonKtor_utils_iosGMTDate, CommonKtor_http_iosHttpStatusCode, CommonKtor_http_iosHttpProtocolVersion, CommonKtor_http_iosContentType, CommonKotlinx_serialization_runtime_nativeEnumDescriptor, CommonKotlinx_serialization_runtime_nativeSerialKind, CommonKotlinNothing, CommonKotlinx_serialization_runtime_nativeUpdateMode, CommonKotlinAbstractCoroutineContextElement, CommonKtor_client_core_iosHttpResponseConfig, CommonKtor_utils_iosPipeline, CommonKtor_utils_iosPipelinePhase, CommonKotlinx_io_nativeByteOrder, CommonKotlinx_coroutines_core_nativeCancellationException, CommonKtor_utils_iosWeekDay, CommonKtor_utils_iosMonth, CommonKtor_http_iosHeaderValueWithParameters, CommonKtor_http_iosHeaderValueParam, CommonKotlinx_serialization_runtime_nativeSerialClassDescImpl, CommonKotlinEnum, CommonKotlinx_io_nativeCharset, CommonKtor_http_iosHttpMethod, CommonKtor_http_iosUrl, CommonKotlinx_io_nativeIoBuffer, CommonKotlinIllegalStateException, CommonKotlinRuntimeException, CommonKotlinException, CommonKotlinx_io_nativeCharsetDecoder, CommonKotlinx_io_nativeCharsetEncoder, CommonKtor_http_iosURLProtocol, CommonKotlinByteArray, CommonKotlinDoubleArray, CommonKotlinFloatArray, CommonKotlinIntArray, CommonKotlinLongArray, CommonKotlinShortArray, CommonKotlinCharArray, CommonKotlinx_coroutines_core_nativeAtomicDesc, CommonKotlinByteIterator, CommonKotlinDoubleIterator, CommonKotlinFloatIterator, CommonKotlinIntIterator, CommonKotlinLongIterator, CommonKotlinShortIterator, CommonKotlinCharIterator, CommonKotlinx_coroutines_core_nativeAtomicOp, CommonKotlinx_coroutines_core_nativeOpDescriptor;

@protocol CommonSettings, CommonBaseView, CommonKotlinCoroutineContext, CommonGithubRepository, CommonGithubView, CommonKtor_client_core_iosHttpClientFeature, CommonKtor_client_core_iosHttpResponse, CommonPlatformLogger, CommonKtor_client_json_iosJsonSerializer, CommonKotlinx_serialization_runtime_nativeKSerializer, CommonKotlinKClass, CommonKotlinx_serialization_runtime_nativeSerializationStrategy, CommonKotlinx_serialization_runtime_nativeEncoder, CommonKotlinx_serialization_runtime_nativeSerialDescriptor, CommonKotlinx_serialization_runtime_nativeDeserializationStrategy, CommonKotlinx_serialization_runtime_nativeDecoder, CommonKotlinCoroutineContextElement, CommonKotlinCoroutineContextKey, CommonKotlinx_coroutines_core_nativeCoroutineScope, CommonKotlinx_io_nativeCloseable, CommonKtor_client_core_iosHttpClientEngine, CommonKtor_utils_iosAttributes, CommonKotlinIterator, CommonKotlinx_coroutines_io_nativeByteReadChannel, CommonKotlinx_coroutines_core_nativeJob, CommonKtor_http_iosHttpMessage, CommonKtor_http_iosHeaders, CommonKotlinKDeclarationContainer, CommonKotlinKAnnotatedElement, CommonKotlinKClassifier, CommonKotlinx_serialization_runtime_nativeCompositeEncoder, CommonKotlinx_serialization_runtime_nativeSerialContext, CommonKotlinAnnotation, CommonKotlinx_serialization_runtime_nativeCompositeDecoder, CommonKotlinContinuationInterceptor, CommonKotlinContinuation, CommonKotlinx_coroutines_core_nativeRunnable, CommonKotlinSuspendFunction2, CommonKtor_client_core_iosHttpRequest, CommonKotlinx_coroutines_io_nativeReadSession, CommonKotlinx_coroutines_core_nativeChildHandle, CommonKotlinx_coroutines_core_nativeChildJob, CommonKotlinx_coroutines_core_nativeDisposableHandle, CommonKotlinSequence, CommonKotlinx_coroutines_core_nativeSelectClause0, CommonKtor_utils_iosStringValues, CommonKotlinMapEntry, CommonKotlinx_serialization_runtime_nativeGeneratedSerializer, CommonKotlinComparable, CommonKotlinSuspendFunction, CommonKotlinx_coroutines_core_nativeParentJob, CommonKotlinx_coroutines_core_nativeSelectInstance, CommonKotlinSuspendFunction0, CommonKtor_http_iosParameters, CommonKotlinx_io_nativeInput, CommonKotlinx_io_nativeOutput, CommonKotlinAppendable, CommonKotlinx_io_nativeObjectPool;
...
@interface CommonPlatformSettings : KotlinBase <CommonSettings>
...
@interface CommonUserModel : KotlinBase
- (instancetype)initWithName:(NSString *)name avatar_url:(NSString *)avatar_url company:(NSString *)company __attribute__((swift_name("init(name:avatar_url:company:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubPresenter")))
@interface CommonGithubPresenter : KotlinBase
- (instancetype)initWithUiContext:(id<CommonKotlinCoroutineContext>)uiContext repository:(id<CommonGithubRepository>)repository __attribute__((swift_name("init(uiContext:repository:)"))) __attribute__((objc_designated_initializer));
- (void)bindView:(id<CommonGithubView>)view __attribute__((swift_name("bind(view:)")));
- (void)unbind __attribute__((swift_name("unbind()")));
- (void)loadUserName:(NSString *)name __attribute__((swift_name("loadUser(name:)")));
- (void)onRepoClickedRepo:(CommonRepository *)repo __attribute__((swift_name("onRepoClicked(repo:)")));
@end;

__attribute__((swift_name("GithubRepository")))
@protocol CommonGithubRepository
@required
@end;

__attribute__((swift_name("GithubView")))
@protocol CommonGithubView <CommonBaseView>
@required
- (void)displayUserUser:(CommonUserModel *)user __attribute__((swift_name("displayUser(user:)")));
- (void)displayReposRepos:(NSArray<CommonRepository *> *)repos __attribute__((swift_name("displayRepos(repos:)")));
...
@interface CommonExpectSuccess : KotlinBase <CommonKtor_client_core_iosHttpClientFeature>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)expectSuccess __attribute__((swift_name("init()")));
- (CommonExpectSuccess *)prepareBlock:(CommonKotlinUnit *(^)(CommonKotlinUnit *))block __attribute__((swift_name("prepare(block:)")));
- (void)installFeature:(CommonExpectSuccess *)feature scope:(CommonKtor_client_core_iosHttpClient *)scope __attribute__((swift_name("install(feature:scope:)")));
@end;
...
@interface CommonApiException : CommonKotlinThrowable
...
@interface CommonGithubApi : KotlinBase
- (instancetype)initWithLogger:(id<CommonPlatformLogger>)logger __attribute__((swift_name("init(logger:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *endPoint;
@property (readonly) id<CommonPlatformLogger> logger;
@end;

__attribute__((swift_name("Ktor_client_json_iosJsonSerializer")))
@protocol CommonKtor_client_json_iosJsonSerializer
@required
- (CommonKtor_http_iosOutgoingContent *)writeData:(id)data __attribute__((swift_name("write(data:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JsonKotlinxSerializer")))
@interface CommonJsonKotlinxSerializer : KotlinBase <CommonKtor_client_json_iosJsonSerializer>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)setMapperSerializer:(id<CommonKotlinx_serialization_runtime_nativeKSerializer>)serializer __attribute__((swift_name("setMapper(serializer:)")));
@property (readonly) CommonMutableDictionary<id<CommonKotlinKClass>, id<CommonKotlinx_serialization_runtime_nativeKSerializer>> *mappers;
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubRepositoryImpl")))
@interface CommonGithubRepositoryImpl : KotlinBase <CommonGithubRepository>
- (instancetype)initWithLogger:(id<CommonPlatformLogger>)logger __attribute__((swift_name("init(logger:)"))) __attribute__((objc_designated_initializer));
@end;
...
- (CommonRepository *)doCopyName:(NSString *)name id:(int32_t)id __attribute__((swift_name("doCopy(name:id:)")));
@property (readonly) NSString *name;
...
@interface CommonRepository$serializer : KotlinBase <CommonKotlinx_serialization_runtime_nativeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)$serializer __attribute__((swift_name("init()")));
- (CommonRepository *)deserializeInput:(id<CommonKotlinx_serialization_runtime_nativeDecoder>)input __attribute__((swift_name("deserialize(input:)")));
- (CommonRepository *)patchInput:(id<CommonKotlinx_serialization_runtime_nativeDecoder>)input old:(CommonRepository *)old __attribute__((swift_name("patch(input:old:)")));
- (void)serializeOutput:(id<CommonKotlinx_serialization_runtime_nativeEncoder>)output obj:(CommonRepository *)obj __attribute__((swift_name("serialize(output:obj:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserJSON")))
@interface CommonUserJSON : KotlinBase
- (instancetype)initWithLogin:(NSString *)login id:(int32_t)id name:(NSString *)name avatar_url:(NSString *)avatar_url company:(NSString *)company __attribute__((swift_name("init(login:id:name:avatar_url:company:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (NSString *)component5 __attribute__((swift_name("component5()")));
- (CommonUserJSON *)doCopyLogin:(NSString *)login id:(int32_t)id name:(NSString *)name avatar_url:(NSString *)avatar_url company:(NSString *)company __attribute__((swift_name("doCopy(login:id:name:avatar_url:company:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserJSON.Companion")))
@interface CommonUserJSONCompanion : KotlinBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<CommonKotlinx_serialization_runtime_nativeKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserJSON.$serializer")))
@interface CommonUserJSON$serializer : KotlinBase <CommonKotlinx_serialization_runtime_nativeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)$serializer __attribute__((swift_name("init()")));
- (CommonUserJSON *)deserializeInput:(id<CommonKotlinx_serialization_runtime_nativeDecoder>)input __attribute__((swift_name("deserialize(input:)")));
- (CommonUserJSON *)patchInput:(id<CommonKotlinx_serialization_runtime_nativeDecoder>)input old:(CommonUserJSON *)old __attribute__((swift_name("patch(input:old:)")));
- (void)serializeOutput:(id<CommonKotlinx_serialization_runtime_nativeEncoder>)output obj:(CommonUserJSON *)obj __attribute__((swift_name("serialize(output:obj:)")));
@end;

__attribute__((swift_name("PlatformLogger")))
@protocol CommonPlatformLogger
@required
- (void)logExceptionTag:(NSString *)tag text:(NSString *)text exception:(CommonKotlinThrowable * _Nullable)exception __attribute__((swift_name("logException(tag:text:exception:)")));
...
@interface CommonKtor_utils_iosGMTDate : KotlinBase
...
@required
- (CommonKotlinx_io_nativeIoBuffer * _Nullable)$ensureNext$Current:(CommonKotlinx_io_nativeIoBuffer *)current __attribute__((swift_name("$ensureNext$(current:)")));
- (CommonKotlinx_io_nativeIoBuffer * _Nullable)$prepareRead$MinSize:(int32_t)minSize __attribute__((swift_name("$prepareRead$(minSize:)")));
- (void)$updateRemaining$Remaining:(int32_t)remaining __attribute__((swift_name("$updateRemaining$(remaining:)")));
...
@required
- (void)$afterWrite$ __attribute__((swift_name("$afterWrite$()")));
- (CommonKotlinx_io_nativeIoBuffer *)$prepareWrite$N:(int32_t)n __attribute__((swift_name("$prepareWrite$(n:)")));
